 ...
 */
public class ContactStatusMatchPredicate implements Predicate<Person> {
     ...
     */
    public ContactStatusMatchPredicate(ArgumentMultimap descriptor) {
    ...
    public boolean test(Person person) {
        ...
        if (userArg.equals("")) {
            ...
            if (personContactedStatus.equals("")) {
                return false;
            } else {
